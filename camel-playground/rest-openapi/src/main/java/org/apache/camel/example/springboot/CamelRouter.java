...
public class CamelRouter extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        rest("/users").description("User REST service")
            ...
            .post("/validate").description("Validate a user").type(User.class)
                .param().name("body").type(body).description("The user to validate").endParam()
                .responseMessage().code(204).message("User successfully validated").endResponseMessage()
                .to("direct:async-validate-user")
        ;
        ...
        from("direct:async-validate-user")
