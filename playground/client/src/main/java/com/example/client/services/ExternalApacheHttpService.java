...
public class ExternalApacheHttpService {
    ...
    public String instrumentedFindAll() {
        ...
        try (CloseableHttpClient httpclient = HttpClients.createDefault()) {
            ...
            HttpGet httpget = new HttpGet("http://localhost:8080/api/posts");
            ...
            Observation observation = Observation.createNotStarted("http.client.requests", () -> context, registry)
                    ...
                    .lowCardinalityKeyValue("http.url", "http://localhost:8080/api/posts")
